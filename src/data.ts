...
export const portfolioItems: PortfolioItem[] = [
    {
        ...
        description: 'Graphical user interface for real-time monitoring of sensor signals interfaced with Arduino. Built with Python and C++, featuring live data visualization and chart plotting. ⭐ 9 stars',
        category: 'tool',
    ...
    },
    {
        ...
        description: 'Visual Studio Code extension providing Dynamics NAV C/AL programming language support with syntax highlighting, IntelliSense, and code snippets. ⭐ 15 stars',
        category: 'tool',
    ...
    },
    {
        ...
        description: 'Interactive Jupyter Notebook series exploring Quantum Harmonic Oscillator theory with Python implementations and visualizations. Educational resource combining physics and programming. ⭐ 7 stars',
        category: 'library',
    ...
    },
    {
        ...
        description: 'Flask-based toy server demonstrating API development and AJAX requests. Generates fake meteorological data for learning purposes, perfect for teaching web development concepts.',
        category: 'api',
    ...
    },
    {
        ...
        description: 'Modern personal portfolio built with Astro, TypeScript, and Tailwind CSS. Features responsive design, dark mode, smooth animations, and component-based architecture. Open source on GitHub.',
        category: 'web-app',
    ...
    },
    {
        ...
        description: 'Pure Python implementation of a poker game with command-line interface. Demonstrates object-oriented programming principles and game logic implementation. ⭐ 4 stars',
        category: 'tool',
    ...
    },
    {
        ...
        description: 'JupyterLab extension for checking weather conditions directly within the notebook environment. Integrates weather APIs with Jupyter workflows for data science applications.',
        category: 'tool',
    ...
    },
    {
        ...
        description: 'Comprehensive teaching materials for Fortran programming courses. Includes lectures, exercises, and examples covering modern Fortran features and scientific computing. ⭐ 3 stars',
        category: 'library',
    ...
    },
    {
        ...
        description: 'Professional resume/CV built with LaTeX using Awesome CV template. Version-controlled, easily maintainable, and generates beautiful PDF output. Available on GitHub and GitLab. ⭐ 3 stars',
        category: 'tool',
    ...
    },
    {
        ...
        description: 'Interactive Jupyter notebooks providing an informal introduction to Cellular Automata theory and implementation. Developed for Code Day 2017 educational workshop. ⭐ 3 stars',
        category: 'library',
        thumbnail: '/brushed/template/_include/img/work/thumbs/image-01.jpg',
        fullImage: '/brushed/template/_include/img/work/full/image-01-full.jpg',
    ...
    },
    {
        ...
        description: 'Teaching materials for "Introduction to High Performance Computing with Python" workshop. Covers parallel processing, optimization techniques, and scientific computing libraries.',
        category: 'library',
        thumbnail: '/brushed/template/_include/img/work/thumbs/image-02.jpg',
        fullImage: '/brushed/template/_include/img/work/full/image-02-full.jpg',
    ...
    },
    {
        ...
        description: 'Quantum computing project testing Variational Quantum Eigensolver (VQE) with various configurations using IBM Qiskit framework. Explores quantum algorithms for optimization problems.',
        category: 'library',
        thumbnail: '/brushed/template/_include/img/work/thumbs/image-03.jpg',
        fullImage: '/brushed/template/_include/img/work/full/image-03-full.jpg',
